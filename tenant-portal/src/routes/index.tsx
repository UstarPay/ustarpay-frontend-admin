  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="dashboard" element={protect(<DashboardPage />, [TENANT_PERMISSION.DASHBOARD_VIEW])} />
        ...
        <Route path="tenant-users/address-books" element={<Navigate to="/tenant-users/list" replace />} />
        ...
        <Route path="hot-wallets/list" element={protect(<HotWalletListPage />, [TENANT_PERMISSION.HOT_WALLETS_VIEW])} />
        <Route path="hot-wallets/:id" element={protect(<HotWalletDetailPage />, [TENANT_PERMISSION.HOT_WALLETS_VIEW])} />
        <Route path="cold-wallets/list" element={protect(<ColdWalletListPage />, [TENANT_PERMISSION.COLD_WALLETS_VIEW])} />
        <Route path="cold-wallets/:id" element={protect(<ColdWalletDetailPage />, [TENANT_PERMISSION.COLD_WALLETS_VIEW])} />
        ...
        <Route path="logs/api" element={protect(<ApiLogPage />, [TENANT_PERMISSION.TENANT_VIEW])} />
        <Route path="logs/webhook" element={protect(<WebhookLogPage />, [TENANT_PERMISSION.TENANT_VIEW])} />
        <Route path="security/2fa" element={protect(<TwoFactorAuthPage />, [TENANT_PERMISSION.SECURITY_2FA])} />
        <Route path="security/password" element={protect(<PasswordUpdatePage />, [TENANT_PERMISSION.TENANT_VIEW])} />
        <Route path="security/secondary-password" element={protect(<SecondaryPasswordUpdatePage />, [TENANT_PERMISSION.TENANT_VIEW])} />
        ...
        <Route path="rbac/permissions" element={protect(<TenantRbacPermissionPage />, [TENANT_PERMISSION.TENANT_RBAC_PERMISSIONS_VIEW])} />
      </Route>
